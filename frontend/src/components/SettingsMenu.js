      ...
      {open && (
        <div className="settings-dropdown">
          ...
          <div className="settings-group">
            ...
            <button
              className="settings-item"
              onClick={() => goTo("/dashboard/settings/password")}
            >
              <LockKeyhole size={16} />
            ...
            <button
              className="settings-item"
              onClick={() => goTo("/dashboard/settings/teams")}
            >
              <UsersRound size={16} />
            ...
            <button
              className="settings-item"
              onClick={() => goTo("/dashboard/settings/block-list")}
            >
              <Ban size={16} />
          ...
          <div className="settings-group">
            ...
            <button
              className="settings-item"
              onClick={() => goTo("/dashboard/affiliates")}
            >
              <Handshake size={16} />
          ...
          <div className="settings-group">
            ...
            <button
              className="settings-item"
              onClick={() => goTo("/dashboard/support")}
            >
              <Headphones size={16} />
