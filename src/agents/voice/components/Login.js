    ...
    <div className="auth-page">
      ...
      <div className="auth-layout">
        ...
        <div className="auth-intro">
          <Link to="/agents/voice" className="auth-brand">
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleLogin} className="auth-form">
            ...
            <div className="form-group">
              <div className="password-label-row">
                ...
                <Link to="/agents/voice/forgot-password" className="forgot-link">
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="auth-bottom">
            Don't have an account? <Link to="/agents/voice/signup">Create an account</Link>
          </p>
          ...
          <Link to="/agents/voice" className="back-home">
