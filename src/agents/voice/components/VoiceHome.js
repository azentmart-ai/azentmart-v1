    ...
    <div className="voice-page">
      ...
      <header className="voice-header">
        <div className="voice-nav">
          ...
          >
            <div className="brand-logo brand-logo-image-wrap">
              <img src={logo} alt="AzentMart AI" className="brand-logo-image" />
            </div>
      ...
      {/* =====================================================
          SHARED AZENTMART FOOTER
          Same structure/content as the main site, themed for Voice AI.
      ===================================================== */}

      <AgentFooter theme="voice" />
