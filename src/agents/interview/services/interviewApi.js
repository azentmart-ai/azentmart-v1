const API_URL = process.env.REACT_APP_INTERVIEW_API_BASE_URL || "http://localhost:8000";
...
export function connectInterviewCopilot(
    ...
    const socket = new WebSocket(
        `${process.env.REACT_APP_INTERVIEW_WS_BASE_URL || "ws://localhost:8000"}/ws/interview/${sessionId}`
    );
