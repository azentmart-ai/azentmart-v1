...
const featuredAgents = [
  { name: "Voice Agent", url: agentUrls.voice, category: "Voice AI", desc: "Automate calls, conversations and customer interactions with a context-aware voice agent.", icon: <FaMicrophone /> },
  { name: "WhatsApp Agent", url: agentUrls.whatsapp, category: "Customer AI", desc: "Qualify leads, answer questions and support customers through real-time WhatsApp conversations.", icon: <FaWhatsapp /> },
  { name: "Instagram Agent", url: agentUrls.instagram, category: "Social AI", desc: "Automate DMs, lead generation and audience engagement without losing the human touch.", icon: <FaInstagram /> },
  { name: "Interview Agent", url: agentUrls.interview, category: "Recruitment AI", desc: "Prepare candidates, organize interview sessions and keep hiring workflows moving.", icon: <FaUserPlus /> },
];
